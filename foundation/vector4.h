...
inline Vec4 Vec4I(int x, int y, int z, int w = 255) {
	return Vec4(static_cast<float>(x) / 255.F, static_cast<float>(y) / 255.F, static_cast<float>(z) / 255.F, static_cast<float>(w) / 255.F);
}
