...
inline Vec4 operator+(const Vec4 &a, const float v) { return Vec4(a.x + v, a.y + v, a.z + v, a.w + v); }
inline Vec4 operator-(const Vec4 &a, const Vec4 &b) { return Vec4(a.x - b.x, a.y - b.y, a.z - b.z, a.w - b.w); }
inline Vec4 operator-(const Vec4 &a, const float v) { return Vec4(a.x - v, a.y - v, a.z - v, a.w - v); }
inline Vec4 operator*(const Vec4 &a, const Vec4 &b) { return Vec4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w); }
inline Vec4 operator*(const Vec4 &a, const float v) { return Vec4(a.x * v, a.y * v, a.z * v, a.w * v); }
...
inline Vec4 operator/(const Vec4 &a, const Vec4 &b) { return Vec4(a.x / b.x, a.y / b.y, a.z / b.z, a.w / b.w); }
inline Vec4 operator/(const Vec4 &v, const float k) { return Vec4(v.x / k, v.y / k, v.z / k, v.w / k); }
