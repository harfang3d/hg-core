...
template <typename T> tVec2<T> operator+(const tVec2<T> &v, const T k) {
	return tVec2<T>(v.x + k, v.y + k);
}
...
template <typename T> tVec2<T> operator*(const T k, const tVec2<T> &v) {
	return v * k;
}
...
template <typename T> tVec2<T> Min(const tVec2<T> &v, const tVec2<T> &m) {
	return tVec2<T>(v.x < m.x ? v.x : m.x, v.y < m.y ? v.y : m.y);
}

template <typename T> tVec2<T> Max(const tVec2<T> &v, const tVec2<T> &m) {
	return tVec2<T>(v.x > m.x ? v.x : m.x, v.y > m.y ? v.y : m.y);
}

/// Squared vector length.
template <typename T> T Len2(const tVec2<T> &v) {
...
/// Dot product.
template <typename T> T Dot(const tVec2<T> &a, const tVec2<T> &b) {
	return a.x * b.x + a.y * b.y;
}
...
/// Reversed vector.
template <typename T> tVec2<T> Reverse(const tVec2<T> &v) {
	return tVec2<T>(-v.x, -v.y);
}

/// Vector squared distance.
template <typename T> T Dist2(const tVec2<T> &a, const tVec2<T> &b) {
