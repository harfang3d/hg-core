...
void test_vec2() {
	...
	}
	{
		Vec2 u(1.4f,-2.75f);
		u += Vec2(-0.2f, 5.25);
		TEST_CHECK(TestEqual(u.x, 1.2f));
		TEST_CHECK(TestEqual(u.y, 2.5f));
	}
	{
		iVec2 u(-8, 5);
		u += iVec2(-2, 1);
	...
	}
	{
		Vec2 u(-3.1f, 10.02f);
		u += 0.1f;
		TEST_CHECK(TestEqual(u.x,-3.f));
		TEST_CHECK(TestEqual(u.y, 10.12f));
	}
	{
		iVec2 u(7,21);
		u += 5;
	...
	}
	{
		...
		TEST_CHECK(TestEqual(u.x,-0.674f));
		TEST_CHECK(TestEqual(u.y, 3.3333f));
	}
	{
		iVec2 u(7,-4);
		u -= iVec2(5,-2);
	...
	}
	{
		...
		u -= 0.004f;
		TEST_CHECK(TestEqual(u.x, 2.3195f));
		TEST_CHECK(TestEqual(u.y, 7.80794f));
	}
	{
		iVec2 u(100, 5);
		u -= 10;
