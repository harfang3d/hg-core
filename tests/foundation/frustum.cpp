...
void test_frustum() {
	...
	TEST_CHECK(AlmostEqual(frustum1[FP_Top], frustum2[FP_Top], 0.000001f));
	TEST_CHECK(AlmostEqual(frustum1[FP_Bottom], frustum2[FP_Bottom], 0.000001f));
	TEST_CHECK(AlmostEqual(frustum1[FP_Left], frustum2[FP_Left], 0.000001f));
	TEST_CHECK(AlmostEqual(frustum1[FP_Right], frustum2[FP_Right], 0.000001f));
	TEST_CHECK(AlmostEqual(frustum1[FP_Near], frustum2[FP_Near], 0.000001f));
	TEST_CHECK(AlmostEqual(frustum1[FP_Far], frustum2[FP_Far], 0.000001f));
