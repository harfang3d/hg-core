...
void test_mat44() {
	...
	}
	{
		...
		TEST_CHECK(AlmostEqual(v[0], Vec4(16.8f, 18.4f, 20.f, 21.6f), 0.000001f));
		TEST_CHECK(AlmostEqual(v[1], Vec4(21.3f, 23.8f, 26.3f, 28.8f), 0.000001f));
		TEST_CHECK(AlmostEqual(v[2], Vec4(25.8f, 29.2f, 32.6f, 36.f), 0.000001f));
		TEST_CHECK(AlmostEqual(v[3], Vec4(30.3f, 34.6f, 38.9f, 43.2f), 0.000001f));
	}
	{
		const Mat44 m(1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 7.f, 8.f, 9.f, 10.f, 11.f, 12.f, 13.f, 14.f, 15.f, 16.f);
