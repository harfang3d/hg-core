...
void test_color() {
	...
	}
	{
		...
		TEST_CHECK(Equal(c0.r, -1.6f));
		TEST_CHECK(Equal(c0.g, 16.f));
		TEST_CHECK(Equal(c0.b, 250.f));
		TEST_CHECK(Equal(c0.a, 20.f));
	}
	{
	...
	}
	{
		...
		Color c2 = c0 / c1;
		TEST_CHECK(Equal(c2.r, 0.32));
		TEST_CHECK(Equal(c2.g, -93.f));
		TEST_CHECK(Equal(c2.b, 3.321865167f));
		TEST_CHECK(Equal(c2.a, 0.0360909f));
	}
	{
