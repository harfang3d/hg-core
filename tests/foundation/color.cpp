...
void test_color() {
	{
		...
		Color c1(c0);
		TEST_CHECK(TestEqual(c1.r, 1.f));
		TEST_CHECK(TestEqual(c1.g, 2.f));
		TEST_CHECK(TestEqual(c1.b, 3.f));
		TEST_CHECK(TestEqual(c1.a, 4.f));
	}
	{
		Color c0(0.22f, 1.4f, -2.75f, -0.3503f);
		c0 += Color(0.042f, -0.2f, 5.25f, 0.9017f);
		TEST_CHECK(TestEqual(c0.r, 0.262f));
		TEST_CHECK(TestEqual(c0.g, 1.2f));
		TEST_CHECK(TestEqual(c0.b, 2.5f));
		TEST_CHECK(TestEqual(c0.a, 0.5514f));
	}
	{
		Color c0(20.97f, -3.1f, 10.02f, -1.402f);
		c0 += 0.1f;
		TEST_CHECK(TestEqual(c0.r, 21.07f));
		TEST_CHECK(TestEqual(c0.g, -3.f));
		TEST_CHECK(TestEqual(c0.b, 10.12f));
		TEST_CHECK(TestEqual(c0.a, -1.302f));
	}
	{
		Color c0(55.555f, 0.336f, 5.5555f, 7.9191f);
		c0 -= Color(2.002f, 1.01f, 2.2222f, 0.054f);
		TEST_CHECK(TestEqual(c0.r, 53.553f));
		TEST_CHECK(TestEqual(c0.g, -0.674f));
		TEST_CHECK(TestEqual(c0.b, 3.3333f));
		TEST_CHECK(TestEqual(c0.a, 7.8651f));
	}
	{
		Color c0(-1.025f, 2.3235f, 7.81194f, -0.40441f);
		c0 -= 0.004f;
		TEST_CHECK(TestEqual(c0.r, -1.029));
		TEST_CHECK(TestEqual(c0.g, 2.3195f));
		TEST_CHECK(TestEqual(c0.b, 7.80794f));
		TEST_CHECK(TestEqual(c0.a, -0.40841f));
	}
	{
		Color c0(7.011f, 4.0f, -11.f, 1.202f);
		c0 *= Color(0.33f, 0.5f, 0.4f, -5.01f);
		TEST_CHECK(TestEqual(c0.r, 2.31363f));
		TEST_CHECK(TestEqual(c0.g, 2.f));
		TEST_CHECK(TestEqual(c0.b, -4.4f));
		TEST_CHECK(TestEqual(c0.a, -6.02202f));
	}
	{
		Color c0(-2.022f, 11.11f, 0.075f, -101.3f);
		c0 *= 0.3f;
		TEST_CHECK(TestEqual(c0.r, -0.6066f));
		TEST_CHECK(TestEqual(c0.g, 3.333f));
		TEST_CHECK(TestEqual(c0.b, 0.0225f));
		TEST_CHECK(TestEqual(c0.a, -30.39f, 0.00001f));
	}
	{
		Color c0(0.4f, 4.8f, -26.f, 1.4f);
		c0 /= Color(-0.25f, 0.3f, -0.104f, 0.07f);
		TEST_CHECK(TestEqual(c0.r, -1.6f));
		TEST_CHECK(TestEqual(c0.g, 16.f));
		TEST_CHECK(TestEqual(c0.b, 250.f));
		TEST_CHECK(TestEqual(c0.a, 20.f));
	}
	{
		Color c0(-2.015f, 0.03f, 27.6f, -0.975f);
		c0 /= 0.75f;
		TEST_CHECK(TestEqual(c0.r, -2.686666666f));
		TEST_CHECK(TestEqual(c0.g, 0.04f));
		TEST_CHECK(TestEqual(c0.b, 36.8f, 0.00001f));
		TEST_CHECK(TestEqual(c0.a, -1.3f));
	}
	{
		Color c0(1.207f, -44.01f, 0.34034f, -54.0127f);
		TEST_CHECK(TestEqual(c0[0], c0.r));
		TEST_CHECK(TestEqual(c0[1], c0.g));
		TEST_CHECK(TestEqual(c0[2], c0.b));
		TEST_CHECK(TestEqual(c0[3], c0.a));
	}
	{
	...
	}
	{
		...
		Color c2 = c0 + c1;
		TEST_CHECK(TestEqual(c2.r, 3.030f));
		TEST_CHECK(TestEqual(c2.g, 1.5f));
		TEST_CHECK(TestEqual(c2.b, -1.5f));
		TEST_CHECK(TestEqual(c2.a, 0.341f));
	}
	{
		Color c0(47.3473f, 0.5f, -0.5f, 0.754f);
		Color c1 = c0 + 0.25f;
		TEST_CHECK(TestEqual(c1.r, 47.5973f));
		TEST_CHECK(TestEqual(c1.g, 0.75f));
		TEST_CHECK(TestEqual(c1.b, -0.25f));
		TEST_CHECK(TestEqual(c1.a, 1.004f));
	}
	{
		Color c0(0.5f, -0.5f, 1.25909f, -0.30303f);
		Color c1(1.f, -1.f, 1.70707f, 0.0101f);
		Color c2 = c0 - c1;
		TEST_CHECK(TestEqual(c2.r, -0.5f));
		TEST_CHECK(TestEqual(c2.g, 0.5f));
		TEST_CHECK(TestEqual(c2.b, -0.44798f));
		TEST_CHECK(TestEqual(c2.a, -0.31313f));
	}
	{
		Color c0(0.5f, -0.5f, 3.333f, 7.05f);
		Color c1 = c0 - 0.25f;
		TEST_CHECK(TestEqual(c1.r, 0.25f));
		TEST_CHECK(TestEqual(c1.g, -0.75f));
		TEST_CHECK(TestEqual(c1.b, 3.083f));
		TEST_CHECK(TestEqual(c1.a, 6.8f));
	}
	{
		Color c0(0.15f, -2.5f, 1.505f, 0.08);
		Color c1(1.1f, 0.3f, 0.76f, 2.04f);
		Color c2 = c0 * c1;
		TEST_CHECK(TestEqual(c2.r, 0.165f));
		TEST_CHECK(TestEqual(c2.g, -0.75f));
		TEST_CHECK(TestEqual(c2.b, 1.1438f));
		TEST_CHECK(TestEqual(c2.a, 0.1632f));
	}
	{
		Color c0(-5.06f, 0.75f, 2.72645f, 0.1717f);
		Color c1 = c0 * 4.25f;
		Color c2 = 4.25f * c0;
		TEST_CHECK(TestEqual(c1.r, -21.505f));
		TEST_CHECK(TestEqual(c1.g, 3.1875f));
		TEST_CHECK(TestEqual(c1.b, 11.5874125f));
		TEST_CHECK(TestEqual(c1.a, 0.729725f));
		TEST_CHECK(TestEqual(c2.r, c1.r));
		TEST_CHECK(TestEqual(c2.g, c1.g));
		TEST_CHECK(TestEqual(c2.b, c1.b));
		TEST_CHECK(TestEqual(c2.a, c1.a));
	}
	{
		Color c0(0.48f, -2.79f, -1.3334f, 0.0794f);
		Color c1(1.5f, 0.03f, -0.401401f, 2.2f);
		Color c2 = c0 / c1;
		TEST_CHECK(TestEqual(c2.r, 0.32));
		TEST_CHECK(TestEqual(c2.g, -93.f));
		TEST_CHECK(TestEqual(c2.b, 3.321865167f));
		TEST_CHECK(TestEqual(c2.a, 0.0360909f));
	}
	{
		Color c0(9.008f, 0.75f, -57.1002f, 3.7f);
		Color c1 = c0 / 0.1f;
		TEST_CHECK(TestEqual(c1.r, 90.08f));
		TEST_CHECK(TestEqual(c1.g, 7.5f));
		TEST_CHECK(TestEqual(c1.b, -571.002));
		TEST_CHECK(TestEqual(c1.a, 37.f));
	}
	{
		Vec3 v(1.f, 2.f, 3.f);
		Color c0 = ColorFromVector3(v);
		TEST_CHECK(TestEqual(c0.r, 1.f));
		TEST_CHECK(TestEqual(c0.g, 2.f));
		TEST_CHECK(TestEqual(c0.b, 3.f));
		TEST_CHECK(TestEqual(c0.a, 1.f));
	}
	{
	...
	}
	{
		...
		TEST_CHECK(TestEqual(c1.r, 1.0f));
		TEST_CHECK(TestEqual(c1.g, -1.0f));
		TEST_CHECK(TestEqual(c1.b, 0.5f));
		TEST_CHECK(TestEqual(c1.a, -0.5f));
	}
	{
		Color c0 = Clamp(Color(-0.75f, 0.5f, 2.1f, -1.f), Color(-1.f, -1.f, 1.5f, -1.2f), Color(-0.5f, 1.f, 3.f, 1.f));
		TEST_CHECK(TestEqual(c0.r, -0.75f));
		TEST_CHECK(TestEqual(c0.g, 0.5f));
		TEST_CHECK(TestEqual(c0.b, 2.1f));
		TEST_CHECK(TestEqual(c0.a, -1.f));

		Color c1 = Clamp(Color(-3.f, 4.f, 1.5f, -1.f), Color(-1.f, -1.f, 2.f, 0.f), Color(-0.5f, 1.f, 3.f, 1.f));
		TEST_CHECK(TestEqual(c1.r, -1.0f));
		TEST_CHECK(TestEqual(c1.g, 1.0f));
		TEST_CHECK(TestEqual(c1.b, 2.0f));
		TEST_CHECK(TestEqual(c1.a, 0.0f));
	}
	{
		TEST_CHECK(TestEqual(ColLen2(ClampLen(Color(1.f, -1.f, 1.f, 1.f), 0.5f, 1.f)), 1.f));
