...
Transform Node::GetTransform() const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeTransform(ref) : Transform(); }
...
Camera Node::GetCamera() const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeCamera(ref) : Camera(); }
...
Object Node::GetObject() const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeObject(ref) : Object(); }
...
Light Node::GetLight() const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeLight(ref) : Light(); }
...
RigidBody Node::GetRigidBody() const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeRigidBody(ref) : RigidBody(); }
...
Collision Node::GetCollision(size_t idx) const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeCollision(ref, idx) : Collision(); }
...
Instance Node::GetInstance() const { return scene_ref && scene_ref->scene ? scene_ref->scene->GetNodeInstance(ref) : Instance(); }
