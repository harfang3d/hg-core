...
typedef gen_ref NodeRef;
extern const NodeRef InvalidNodeRef;

typedef gen_ref ComponentRef;
...
//
struct TransformTRS {
	TransformTRS() : pos(0, 0, 0), rot(0, 0, 0), scl(1, 1, 1) {}
	Vec3 pos, rot, scl;
};
...
//
enum RigidBodyType { RBT_Dynamic, RBT_Kinematic, RBT_Static, RBT_Last };
...
//
enum CollisionType { CT_Sphere, CT_Cube, CT_Cone, CT_Capsule, CT_Cylinder, CT_Mesh, CT_MeshConvex, CT_Last };
